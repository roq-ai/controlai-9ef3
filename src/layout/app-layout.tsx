...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Attacks', path: '/attacks', entity: 'attack', service: AccessServiceEnum.PROJECT, icon: FiAlertCircle },
    { name: 'Defenses', path: '/defenses', entity: 'defense', service: AccessServiceEnum.PROJECT, icon: FiShield },
    { name: 'Models', path: '/models', entity: 'model', service: AccessServiceEnum.PROJECT, icon: FiFile },
